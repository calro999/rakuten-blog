...
# 北欧・韓国雑貨＆家具特化のキーワードリスト (メイン: 約85%)
NORDIC_KOREAN_INTERIOR_KEYWORDS = [
    # 北欧インテリア・家具
    "北欧 木製 サイドテーブル", "北欧風 遮光カーテン", "北欧風 チェスト タンス",
    "真鍮 ペンダントライト 北欧", "テーブルランプ 北欧 アンティーク", "陶器 フラワーベース 北欧",
    "北欧 アートパネル ウォールデコ", "キャンドルホルダー ガラス 北欧", "珪藻土バスマット グレー",
    "スリム 傘立て 北欧", "玄関マット 天然素材 北欧風", "ブレッドケース キッチン収納",
    "調味料ラック ステンレス", "キャスター付き ワゴン 北欧", "リードディフューザー 北欧風",
    "木製 ティッシュケース", "真鍮 アクセサリートレイ", "卓上 ミラー 木枠 北欧",
    "ジュエリーボックス 大容量", "マガジンラック 壁掛け", "ウッドカーペット ナチュラル",
    ...
    "韓国インテリア ラック 透明", "韓国風 ジュエリーケース"
]

# ふるさと納税＋スイーツ特化のキーワードリスト (箸休め: 約15% / みかん・フルーツ除外)
...
def generate_keyword() -> str:
    """
    メイン（北欧・韓国インテリア家具）85%、箸休め（ふるさと納税スイーツ）15%の確率でキーワードを取得する。
    """
    if random.random() < 0.85:
        return random.choice(NORDIC_KOREAN_INTERIOR_KEYWORDS)
    else:
