...
# 雑貨・インテリア特化のキーワードリスト
INTERIOR_KEYWORDS = [
    "北欧 ラグマット", "遮光カーテン おしゃれ", "リネン クッションカバー",
    "木製 サイドテーブル", "真鍮 ペンダントライト", "テーブルランプ アンティーク",
    "陶器 フラワーベース", "壁掛け アートフレーム", "キャンドルホルダー ガラス",
    "珪藻土バスマット グレー", "アイアン タオルハンガー", "ランドリーバスケット キャスター付き",
    "スリム 傘立て", "玄関マット 天然素材", "ブレッドケース キッチン収納",
    "調味料ラック ステンレス", "突っ張り キッチンラック", "フェイクグリーン 大型",
    "ハンギング プランター", "キャスター付き ワゴン 収納", "リードディフューザー",
    "ルームスプレー オーガニック", "洗える スリッパ", "木製 ティッシュケース",
    "真鍮 アクセサリートレイ", "卓上 ミラー 木枠", "ジュエリーボックス 大容量",
    "マガジンラック 壁掛け", "ウッドカーペット", "ビーズクッション カバー付き",
    "ローテーブル 折りたたみ", "ハンガーラック スリム", "壁掛け時計 静音",
    "LEDデスクライト 充電式", "アロマストーン 皿付き", "フェルト 収納バスケット",
    "珪藻土 コースター", "ウッドプレート 食器", "ガラス キャニスター",
    "セラミック コーヒーミル", "南部鉄器 急須", "北欧風 ランチョンマット",
    "エプロン リネン", "ウォールシェルフ 賃貸", "ドアストッパー おしゃれ",
    "スツール 木製", "座椅子 コンパクト", "デスクオーガナイザー",
    "ケーブルボックス 木目", "スマートゴミ箱 分別", "ペダルペール スリム",
    "バスマット 速乾", "フェイスタオル 今治", "ルームシューズ 冬",
    "マルチカバー ソファ", "キルトラグ", "ハニカムシェード",
    "間接照明 スタンド", "アロマディフューザー 超音波", "時計 デジタル 木目",
    "フットライト 人感センサー", "壁掛けミラー 八角形", "キーフック 玄関",
    "シューケアセット", "サボテン ミニ", "多肉植物 寄せ植え",
    "ドライフラワー スワッグ", "ポスターフレーム B2", "マグネット フック 強力",
    "吊り下げ収納 クローゼット", "衣装ケース 引き出し"
]

# スイーツ特化のキーワードリスト
SWEETS_KEYWORDS = [
    "とろける チョコレート タルト", "高級 プリン 詰め合わせ", "濃厚 チーズケーキ ベイクド",
    "抹茶 バウムクーヘン", "マカロン ギフト おしゃれ", "フィナンシェ 焼き菓子 個包装",
    "生キャラメル 北海道", "贅沢 ジェラート アイス", "フルーツ大福 いちご",
    "和菓子 カステラ 老舗", "どら焼き 極上", "ピスタチオ クッキー",
    "ガトーショコラ 濃厚", "モンブラン ケーキ 冷凍", "シュークリーム カスタード",
    "ラスク ギフト チョコ", "シフォンケーキ ふわふわ", "レーズンサンド 絶品",
    "プリン とろとろ 瓶入り", "わらび餅 本わらび粉", "アップルパイ 焼きたて",
    "フロランタン 訳あり", "ロールケーキ 生クリーム", "タルト アソート"
]

# ふるさと納税特化のキーワードリスト
FURUSATO_KEYWORDS = [
    "ふるさと納税 シャインマスカット", "ふるさと納税 牛肉 ステーキ", "ふるさと納税 カニ ズワイガニ",
    "ふるさと納税 うなぎ 蒲焼", "ふるさと納税 いくら 醤油漬け", "ふるさと納税 米 コシヒカリ",
    "ふるさと納税 返礼品 豚肉", "ふるさと納税 ハンバーグ 温めるだけ", "ふるさと納税 訳あり ホタテ",
    "ふるさと納税 みかん 甘い", "ふるさと納税 ビール アサヒ", "ふるさと納税 炭酸水 ストレート",
    "ふるさと納税 牛タン 厚切り", "ふるさと納税 スイーツ バスクチーズケーキ", "ふるさと納税 餃子 冷凍",
    "ふるさと納税 トイレットペーパー ダブル", "ふるさと納税 ティッシュペーパー 大容量", "ふるさと納税 焼き鳥 串セット",
    "ふるさと納税 果物 さくらんぼ", "ふるさと納税 干物 詰め合わせ", "ふるさと納税 サーモン 刺身用",
    "ふるさと納税 缶チューハイ", "ふるさと納税 もつ鍋 セット", "ふるさと納税 熟成肉 ミニ"
]
...
def generate_keyword() -> str:
    """各カテゴリからランダムにキーワードを取得する。"""
    categories = [INTERIOR_KEYWORDS, SWEETS_KEYWORDS, FURUSATO_KEYWORDS]
...
"""
    ...
    system_message = "あなたは楽天ROOMでフォロワー急増中の北欧雑貨・インテリア専門インフルエンサーです。毎日の暮らしがもっと楽しく、お部屋が素敵に整うようなアイテムの魅力を日本語のみで発信してください。"
